export const coco832Instructions = {
    steps: [
        {
            title: "File Requirements",
            items: [
                { text: "Input file must have a header row" },
                { text: "Required headers: 'Item', 'Description', 'Master Pack Qty', 'Weight'" },
        ...
        },
        {
            ...
            items: [
                ...
                { text: "Column N: Copy from input column with header 'Master Pack Qty'" },
