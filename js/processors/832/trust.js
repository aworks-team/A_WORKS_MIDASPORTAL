...
const trust832Processor = {
    ...
    process(data) {
        ...
        const columnIndices = {
            ...
            pcsPerCtn: utils.text.findHeaderIndex(headers, 'PCS / CTN'),
        ...
        validRows.forEach((row, index) => {
            ...
            result[index][labels.indexOf('C')] = 'TRUST';
            ...
            // Column N - PCS/CTN
            if (row[columnIndices.pcsPerCtn]) {
                result[index][labels.indexOf('N')] = utils.text.cleanupSpecialCharacters(row[columnIndices.pcsPerCtn]);
            }
...
export default trust832Processor;